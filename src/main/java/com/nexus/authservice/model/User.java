...
public class User {
    ...
    public User(UUID id, String indexNumber, String fullName, String email, 
                String passwordHash, String preferredLanguage, String signDialect, 
                String medicalPreferences, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
    ...
    public void setSignDialect(String signDialect) {
        this.signDialect = signDialect;
    }
